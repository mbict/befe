...
import (
	"context"
	"fmt"
	"github.com/mbict/befe/proxy/internal/ascii"
...
func (p *ReverseProxy) modifyResponse(rw http.ResponseWriter, res *http.Response, req *http.Request, responseModifier ResponseModifier) bool {
...
func (p *ReverseProxy) ServeHTTP(rw http.ResponseWriter, req *http.Request, responseModifier ResponseModifier) {
	...
	if res.StatusCode == http.StatusSwitchingProtocols {
		if !p.modifyResponse(rw, res, outreq, responseModifier) {
			return
		}
