...
func TestRouter(t *testing.T) {
	...
	routed := false
	router.Handle(http.MethodGet, "/user/:name", func(w http.ResponseWriter, r *http.Request) (bool, error) {
		routed = true
...
func TestRouterAPI(t *testing.T) {
	...
	router := New()
	router.GET("/GET", func(w http.ResponseWriter, r *http.Request) (bool, error) {
		get = true
		return true, nil
	})
	router.HEAD("/GET", func(w http.ResponseWriter, r *http.Request) (bool, error) {
		head = true
		return true, nil
	})
	router.OPTIONS("/GET", func(w http.ResponseWriter, r *http.Request) (bool, error) {
		options = true
		return true, nil
	})
	router.POST("/POST", func(w http.ResponseWriter, r *http.Request) (bool, error) {
		post = true
		return true, nil
	})
	router.PUT("/PUT", func(w http.ResponseWriter, r *http.Request) (bool, error) {
		put = true
		return true, nil
	})
	router.PATCH("/PATCH", func(w http.ResponseWriter, r *http.Request) (bool, error) {
		patch = true
		return true, nil
	})
	router.DELETE("/DELETE", func(w http.ResponseWriter, r *http.Request) (bool, error) {
		delete = true
		return true, nil
	})
