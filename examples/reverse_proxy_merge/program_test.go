	...
	testcases := []struct {
		...
		},
		{
			...
			mockServer: httpmock.New(func(s *httpmock.Server) {
				...
				s.ExpectGet("/bff/product-plans?account_id=123,345,678&size=1000").
					ReturnCode(500)
			}),
			expectedCode: 500,
		},
		{
			...
			expectedJson: JSON{
				"data": []interface{}{
					JSON{"id": "123", "product_plans": []JSON{{"account_id": "123", "id": "102"}}},
					JSON{"id": "345"},
					JSON{"id": "678", "product_plans": []JSON{{"account_id": "678", "id": "101"}, {"account_id": "678", "id": "103"}}},
				},
				"metadata": JSON{"total": 3},
			},
		},
